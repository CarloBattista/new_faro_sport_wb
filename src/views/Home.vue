  ...
  <main class="relative z-[1] w-full">
    ...
    <section id="gallerySection" class="w-full py-10 lg:px-[90px] px-8 flex flex-col gap-4 items-center justify-center">
      ...
      <div class="w-full h-[450px] lg:max-h-[450px] grid lg:grid-cols-2 grid-cols-1 gap-2.5">
        <div
          class="card-image cr-image-one w-full h-full rounded-l-none lg:rounded-l-2xl rounded-tl-2xl lg:rounded-tr-none rounded-tr-2xl"
        ...
        <div class="relative w-full h-full grid grid-cols-2 gap-2.5">
          ...
          <div
            class="card-image cr-image-three w-full h-full lg:rounded-tr-2xl rounded-tr-none lg:rounded-br-none rounded-br-2xl"
          ...
          <div class="absolute bottom-2.5 right-2.5">
            <button-pr
              :hasIcon="false"
              :size="store.isMobile ? 'min' : 'default'"
              type="secondary"
              label="Mostra tutte le foto"
              :disabled="false"
              @click="openGallery(0)"
            />
          </div>
      ...
      <div class="w-full flex items-center justify-center flex-wrap gap-y-[50px]">
        <card-info title="Come arrivare">
          ...
          <template #cta>
            <a
              target="_blank"
              href="https://maps.google.com/maps/dir//Via+Anello+di+San+Cataldo+74122+Taranto+TA/@40.4135818,17.2062347,17z/data=!4m5!4m4!1m0!1m2!1m1!1s0x13471c7b21b0b265:0x24e5bbfd4ce52ac3"
            >
...
.cr-image-one {
  background-image: url('/_resources/images/image_14.webp');
}
...
.cr-image-three {
  background-image: url('/_resources/images/image_15.webp');
}
