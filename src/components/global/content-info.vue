<template>
  <div class="relative w-full flex flex-col">
    <div class="w-full px-8 py-11 flex gap-6 flex-wrap bg-black text-white">
      ...
      <div class="w-[280px] max-w-[280px] flex flex-col gap-[6px]">
        ...
        <div class="flex gap-[6px] items-center">
          <a
            class="relative h-6 aspect-square flex items-center justify-center cursor-pointer"
            target="_blank"
            name="Facebook"
            aria-label="Visita la nostra pagina Facebook"
            href="https://www.facebook.com/profile.php?id=100063539144589"
          >
            <svg class="fill-white" width="11" height="20" viewBox="0 0 11 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
    ...
    <div class="w-full min-h-[45px] px-8 py-2.5 bg-[#151515] flex flex-col gap-1 items-center justify-center">
      ...
      <p class="text-[#909090] text-xs font-normal text-center opacity-70">
        Sito creato da <a class="border-b" target="_blank" href="https://www.linkedin.com/in/carlo-battista-05b926282/">Carlo Battista</a>
      </p>
    </div>
  </div>
</template>
