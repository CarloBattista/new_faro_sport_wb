            ...
            <div class="w-[280px] max-w-[280px] flex flex-col gap-[6px]">
                ...
                <div class="flex gap-[6px] items-center">
                    <a class="relative h-6 aspect-square flex items-center justify-center cursor-pointer"
                        target="_blank" name="Facebook" aria-label="Visita la nostra pagina Facebook" href="https://www.facebook.com/profile.php?id=100063539144589">
                    ...
                    <a class="relative h-6 aspect-square flex items-center justify-center cursor-pointer"
                        target="_blank" name="Instagram" aria-label="Visita la nostra pagina Instagram" href="https://www.instagram.com/newfarosport/">
